...
1. [Fork it](https://github.com/pyrech/gcode-estimator/fork_select)
2. improve it
...
GcodeEstimator's coding standards:
...
```shell
git remote add upstream https://github.com/pyrech/gcode-estimator.git
```
